...
SCENARIO("Scenes can be added, activated and deleted") {
    ...
    GIVEN("Engine with scene manager") {
        ...
        WHEN("Add multiple nodes to scene") {
            ...
            auto layer_1_node_2 = std::make_shared<simple2dengine::CanvasNode>(engine, "layer_1_node_2");
            scene->addChild(layer_1_node_2);
            auto layer_1_node_3 = std::make_shared<simple2dengine::Node>(engine, "layer_1_node_3");
            scene->addChild(layer_1_node_3);
            auto layer_1_node_4 = std::make_shared<simple2dengine::MusicNode>(engine, "layer_1_node_4");
            scene->addChild(layer_1_node_4);

            auto layer_2_node_1 = std::make_shared<simple2dengine::SpriteNode>(engine, "layer_2_node_1");
            layer_1_node_2->addChild(layer_2_node_1);
            auto layer_2_node_2 = std::make_shared<simple2dengine::CanvasNode>(engine, "layer_2_node_2");
            layer_1_node_2->addChild(layer_2_node_2);

            auto layer_3_node_1 = std::make_shared<simple2dengine::TextNode>(engine, "layer_3_node_1");
            ...
            layer_2_node_1->setImage("assets/player.png");
            layer_3_node_1->setFont("assets/font.ttf", false);
            layer_3_node_1->setFont("assets/font.ttf");
